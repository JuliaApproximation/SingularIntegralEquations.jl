...
#TODO: New operator SingularIntegral, but for now they route to the same thing.
Base.getindex{S,V,O,T1,T2}(⨍::DefiniteLineIntegral{V,T1},f::ProductFun{S,V,CauchyWeight{O},T2}) = Hilbert(⨍.domainspace,O)[f]
