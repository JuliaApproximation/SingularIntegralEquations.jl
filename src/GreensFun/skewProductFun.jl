...
function skewProductFun(f::Function,sp::TensorSpace{Tuple{Chebyshev,Chebyshev}};tol=100eps())
    for logn = 4:10
...
function skewProductFun(f::Function,sp::TensorSpace{Tuple{Laurent,Laurent}};tol=100eps())
    for logn = 4:10
...
function skewtransform!{T}(S::TensorSpace{Tuple{Chebyshev,Chebyshev}},M::Matrix{T};kindx::Int=1,kindy::Int=2)
    n=size(M,1)
...
function iskewtransform!{T}(S::TensorSpace{Tuple{Chebyshev,Chebyshev}},M::Matrix{T};kindx::Int=1,kindy::Int=2)
    n=size(M,1)
...
function skewtransform!{T}(S::TensorSpace{Tuple{Laurent,Laurent}},M::Matrix{T})
    n=size(M,1)
...
function iskewtransform!{T}(S::TensorSpace{Tuple{Laurent,Laurent}},M::Matrix{T})
    n=size(M,1)
...
function skewpoints(d::TensorSpace{Tuple{Chebyshev,Chebyshev}},n,m,k;kindx::Int=1,kindy::Int=2)
...
function skewpoints(d::TensorSpace{Tuple{Laurent,Laurent}},n,m,k)
