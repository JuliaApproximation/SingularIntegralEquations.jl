...
function lhelm_riemanniancomplex{T<:Number}(z::T,z0::T,ζ::T,ζ0::T,E::Real)
    N = 100
...
lhelm_riemannian{T<:Number}(x::T,x0::T,y::T,y0::T,E::T) = lhelm_riemanniancomplex(complex(x,y),complex(x0,y0),complex(x,-y),complex(x0,-y0),E)
lhelm_riemannian(x::Number,y::Number,E::Real) = lhelm_riemannian(real(x),real(y),imag(x),imag(y),E)
