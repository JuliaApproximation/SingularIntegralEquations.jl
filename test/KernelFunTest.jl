...
G = ProductFun(fK,Chebyshev(d),Chebyshev(d);method=:convolution)
G1 = ProductFun(fK,Ultraspherical{1}(d),Chebyshev(d);method=:convolution)
G2 = ProductFun(fK,Ultraspherical{1}(d),ChebyshevDirichlet{1,1}(d);method=:convolution)
...
ProductFun(fK,Ultraspherical{1}(d),ChebyshevDirichlet{1,1}(d);method=:convolution)
@time G = ProductFun(fK,Ultraspherical{1}(d),ChebyshevDirichlet{1,1}(d);method=:convolution)
